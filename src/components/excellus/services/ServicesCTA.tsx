  ...
  return (
    <section className="relative py-8 md:py-36 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-px opacity-25 pointer-events-none"
        ...
        aria-hidden="true"
      />
      <div className="absolute bottom-0 left-0 right-0 h-px opacity-25 pointer-events-none"
        style={{ background: "linear-gradient(90deg, transparent, hsl(44 90% 65%), transparent)" }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 50% 40% at 50% 50%, hsl(44 90% 60%), transparent)" }}
        aria-hidden="true"
      />
      ...
      <div className="relative container mx-auto px-4 md:px-6 text-center">
        <div className="flex items-center justify-center gap-2 md:gap-3 mb-5">
          ...
          <span className="eyebrow" style={{ color: "hsl(44 90% 72%)" }}>Vamos Começar</span>
          <span className="gold-divider w-8 md:w-14" />
        </div>
        ...
        <p className="mt-5 md:mt-8 text-[0.65rem] md:text-lg text-white/70 font-light max-w-lg mx-auto leading-relaxed">
          Fale com nossa equipe e receba uma consultoria personalizada,
          sem compromisso, para o seu projeto.
        </p>

        <div className="mt-8 md:mt-12 flex flex-wrap items-center justify-center gap-5">
          <Button
            asChild
            size="lg"
